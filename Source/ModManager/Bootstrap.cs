...
namespace EdBFluffy.ModOrderWithVersionChecking
{
	...
	public class Bootstrap : ITab
    {
		public Bootstrap() : base()
        {
            ...
            // In addition, the add component returns the instance of the component that
            // was created. We can attach this back to the controller in a static field
            // so we can use it as a singleton - and call functions on it.
            ModController.instance = gameObject.AddComponent<ModController>();
        }
