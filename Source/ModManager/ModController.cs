...
namespace EdBFluffy.ModOrderWithVersionChecking
{
    ...
    class ModController : UnityEngine.MonoBehaviour
    {
		...
		public static readonly string ModName = "Mod Manager";

		// The name we're using to store this controller class as a GameObject in the Unity engine.
		public static readonly string GameObjectName = "FluffyModManagerController";

        // The instance of this gameobject, will be set in the bootstrapper.
		...
		{
			// Find the Bootstrap tab class that was created.  RimWorld stores all of its tabs in
